...
class ReceivedRequestsTab extends ConsumerStatefulWidget {
  const ReceivedRequestsTab({super.key});

  @override
  ConsumerState<ReceivedRequestsTab> createState() =>
      _ReceivedRequestsTabState();
}

class _ReceivedRequestsTabState extends ConsumerState<ReceivedRequestsTab> {
  ...
  void _fetchPage(int pageKey) async {
    try {
      final newPage = await ref.read(receivedRequestsProvider(pageKey).future);
      ...
      child: PagedListView<int, dynamic>(
        ...
        builderDelegate: PagedChildBuilderDelegate<dynamic>(
          itemBuilder: (context, item, index) => FriendRequestItem(
            user: item,
            action: FriendItemAction.accept,
          ),
